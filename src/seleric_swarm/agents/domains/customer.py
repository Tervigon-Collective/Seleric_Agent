"""Customer intelligence domain expertise and governed data access."""
    ...
    async def run(self, ctx: AgentContext) -> dict[str, Any]:
        ...
        if metric_id and metric_id not in allowed_metrics:
            return {
                ...
                "error_message": f"Customer agent does not own {metric_id}",
                "unsupported_reason": f"Metric {metric_id} is outside customer allowlist",
