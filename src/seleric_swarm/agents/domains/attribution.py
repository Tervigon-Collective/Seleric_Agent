"""First-party attribution domain expertise and governed data access."""
    ...
    async def run(self, ctx: AgentContext) -> dict[str, Any]:
        ...
        if metric_id and metric_id not in allowed_metrics:
            return {
                ...
                "error_message": f"Attribution agent does not own {metric_id}",
                "unsupported_reason": f"Metric {metric_id} is outside attribution allowlist",
